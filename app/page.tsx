        ...
        <div className="min-h-screen w-screen flex flex-col">
            <section className="bg-primary text-primary-foreground py-24 text-center px-4">
                ...
                <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto">
                    Experience real-time code generation with AI-powered assistance. Write, preview, and deploy code
                    instantly
            ...
            <section className="py-16 px-4">
                <div className="max-w-screen-lg mx-auto">
                    <div className="flex justify-center items-center">
                        <div
                            className="justify-center items-center gap-12 mb-16 rounded-full shadow-xl inline-flex px-10">
                    ...
                    <div className="space-y-6 text-lg max-w-3xl mx-auto">
                        <p>
                            Transform your development workflow with our AI coding assistant that combines natural
                            language
                            understanding with real-time code generation. Simply describe what you want to build, and
                            watch as your
                            ideas come to life with instant code previews.
                        </p>
                        <p>
                            Built with Next.js for the frontend, FastAPI for the backend, and powered by advanced AI
                            models, this
                            system provides an intuitive interface for generating, previewing, and deploying code - all
                            through
